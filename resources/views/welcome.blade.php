    ...
    <body class="antialiased">
            ...
            <main class="main" id="top">
                <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" data-navbar-on-scroll="data-navbar-on-scroll">
                  <div class="container"><a class="navbar-brand" href="{{ url('/') }}"><img src="assets/img/icons/logo.png" alt="" width="30" /><span class="text-1000 fs-1 ms-2 fw-medium">Lasles<span class="fw-bold">VPN</span></span></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      <ul class="navbar-nav mx-auto border-bottom border-lg-bottom-0 pt-2 pt-lg-0">
                        ...
                        <li id="Features" class="nav-item"><a class="nav-link" href="#">Features</a></li>
                      ...
                      <form class="d-flex py-3 py-lg-0">
                        ...
                        @if (Route::has('login'))
                            ...
                            @else
                                ...
                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="btn btn-outline-danger rounded-pill order-0">Register</a>
                                @endif
                            @endauth
                    @endif
